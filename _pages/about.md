...
**I'm a Computer Science PhD in Robotics and AI at Stanford University**. I am currently advised by [Monroe Kennedy](https://profiles.stanford.edu/monroe-kennedy) and [Jeannette Bohg](https://web.stanford.edu/~bohg/). I am interested in constructing rich visual-tactile representations for dexterous manipulation, and using those representations to imbue robots with the ability to perform fine-grained tasks. I am generously funded by the [National Science Foundation Graduate Fellowship](https://www.nsfgrfp.org). 
